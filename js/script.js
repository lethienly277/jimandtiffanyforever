  ...
  $(document).ready(function () {
    ...
    function applySectionBackgrounds() {
      ...
      $('section, .parallax, .gallery-bg').each(function () {
        var $el = $(this)
        var image = isMobile ? $el.attr('data-image-mobile') : $el.attr('data-image')
        ...
        if (image) {
          // wrap in quotes so filenames with spaces / parentheses still work
    ...
    /*CountDown*/
    $('.married_coundown').countdown({ until: new Date(2026, 11, 6) })
